...
('content_structure', 'Site content modules fields structure', 'This tool allows agents to understand the structure of content modules fields,  allowing them to call content adding and editing with correct data. It provide knowledge of what content modules are available and what the fields in them, event if fields are changed in fields builder.', '{}', NULL, 0, 0, 1),
('content_get', 'Site content modules get content', 'This tool allows agents to get info about specific content by module name and content id.', '{}', NULL, 0, 0, 1);
