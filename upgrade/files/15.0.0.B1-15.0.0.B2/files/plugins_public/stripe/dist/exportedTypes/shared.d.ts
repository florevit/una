import type { ConnectElementCommonMethodConfig, ConnectElementCustomMethodConfig, connectElementTagNames } from "../components/componentsAndSetters";
...
type ConnectElementCommonMethods = typeof ConnectElementCommonMethodConfig;
export type ConnectHTMLElementRecord = {
    [K in keyof ConnectElementCustomMethods]: HTMLElement & ConnectElementCustomMethods[K] & ConnectElementCommonMethods;
} & {
