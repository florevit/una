-- FORMS
DELETE FROM `sys_form_displays` WHERE `display_name`='bx_group_edit_settings';
INSERT INTO `sys_form_displays`(`object`, `display_name`, `module`, `view_mode`, `title`) VALUES 
('bx_group', 'bx_group_edit_settings', 'bx_groups', 0, '_bx_groups_form_profile_display_edit_settings');

DELETE FROM `sys_form_inputs` WHERE `object`='bx_group' AND `name`='stg_tabs';
...
DELETE FROM `sys_form_display_inputs` WHERE `display_name`='bx_group_edit_settings';
